...
# load the data
print(os.getcwd())
x_train, x_test = util.load_specgrams('data/spectrograms', (513, 128), train_split=0.8, n_samples=n_samples)
y_train, y_test = util.load_params('data/params', train_split=0.8, n_samples=n_samples)
